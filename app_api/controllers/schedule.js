...
module.exports.scheduleList = function(req,res){
	...
	var options = {//6&$skip=6&$select=%D0%A0%D0%B0%D1%81%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5,%D0%94%D0%B5%D0%BD%D1%8C%D0%9D%D0%B5%D0%B4%D0%B5%D0%BB%D0%B8
		url: 'http://1cServer/cp/odata/standard.odata/Document_%D0%A0%D0%B0%D1%81%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D0%B5%D0%9D%D0%B0%D0%94%D0%B0%D1%82%D1%83?$format=json&$orderby=Number desc&$top=1',
		headers: {
	...
	.then(function (response) {
		...
		for(var i in schedule){
		  ...
		  var resDiscipline = rs('GET', "http://1cServer/cp/odata/standard.odata/Catalog_%D0%94%D0%B8%D1%81%D1%86%D0%B8%D0%BF%D0%BB%D0%B8%D0%BD%D1%8B?$format=json&$select=Ref_Key,Description&$filter=Ref_Key eq guid'"+masDiscipline.join("' or Ref_Key  eq  guid'")+"'", {
		    headers: {'Authorization': 'Basic '+token}
		  });
		  var resTeacher = rs('GET', "http://1cServer/cp/odata/standard.odata/Catalog_%D0%A1%D0%BE%D1%82%D1%80%D1%83%D0%B4%D0%BD%D0%B8%D0%BA%D0%B8?$format=json&$select=Ref_Key,Description&$filter=Ref_Key eq guid'"+masTeacher.join("' or Ref_Key  eq  guid'")+"'", {
		    headers: {'Authorization': 'Basic '+token}
		  });
		  		  var resAuditorium = rs('GET', "http://1cServer/cp/odata/standard.odata/Catalog_%D0%90%D1%83%D0%B4%D0%B8%D1%82%D0%BE%D1%80%D0%B8%D0%B8?$format=json&$select=Ref_Key,Description&$filter=Ref_Key eq guid'"+masAuditorium.join("' or Ref_Key  eq  guid'")+"'", {
		    headers: {'Authorization': 'Basic '+token}
		  });
		  		  var resGroup = rs('GET', "http://1cServer/cp/odata/standard.odata/Catalog_%D0%A3%D1%87%D0%B5%D0%B1%D0%BD%D1%8B%D0%B5%D0%93%D1%80%D1%83%D0%BF%D0%BF%D1%8B?$format=json&$select=Ref_Key,Description&$filter=Ref_Key eq guid'"+masGroup.join("' or Ref_Key  eq  guid'")+"'", {
		    headers: {'Authorization': 'Basic '+token}
		  });
		  	...
		  	for(var i in schedule){
		  	  ...
		  	  function sort(A, A) {
		  	    return A['ДеньНедели'] - A['ДеньНедели'];
		  	  }
		  	  for (var i = 0; i < schedule.length; i++) {
		  	  }
		  	  
		  send(res,200,schedule.sort(sort));
...
module.exports.subjectList = function(req,res){
	var options = {
		url: 'http://1cServer/cp/odata/standard.odata/Catalog_%D0%A3%D1%87%D0%B5%D0%B1%D0%BD%D1%8B%D0%B5%D0%93%D1%80%D1%83%D0%BF%D0%BF%D1%8B?'+
...
module.exports.classes = function(req,res) {
	var options = {
		url: 'http://1cServer/cp/odata/standard.odata/Catalog_%D0%90%D1%83%D0%B4%D0%B8%D1%82%D0%BE%D1%80%D0%B8%D0%B8?'+
